...
useEffect(() => {
    ...
    consoleText(
      ['<Innovation begins where the semicolon ends>', '<Software engineers: turning caffeine into functions since forever>', '<If code is poetry, we are writing an epic every day>', '<Ctrl+C and Ctrl+V — the foundation of modern programming>'],
      'text',
